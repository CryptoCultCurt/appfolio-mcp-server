...
import { getCashflowReport, CashflowReportArgs } from './reports/cashflowReport'; // Corrected casing
...
async function getPropertyDirectoryReport(args: any): Promise<any> {
  if (!VHOST || !USERNAME || !PASSWORD) throw new Error('Missing AppFolio API credentials');
